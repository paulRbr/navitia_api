module NavitiaApi
  ...
  module Configurable
    ...
    #   @return [String] Base URL for API requests. default: https://api.sncf.com/
    ...
    class << self
      ...
      # List of configurable keys for {NavitiaApi::Client}
   ...
   # Compares client options to a Hash of requested options
    ...
    def reset!
      NavitiaApi::Configurable.keys.each do |key|
        instance_variable_set(:"@#{key}", NavitiaApi::Default.options[key])
      end
      self
    end
    ...
    def options
      Hash[NavitiaApi::Configurable.keys.map{|key| [key, instance_variable_get(:"@#{key}")]}]
    end
  end
end
